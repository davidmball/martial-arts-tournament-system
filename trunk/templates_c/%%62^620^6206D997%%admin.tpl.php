<?php /* Smarty version 2.6.20, created on 2015-02-17 22:31:42
...
$this->_sections['section_list']['last']       = ($this->_sections['section_list']['iteration'] == $this->_sections['section_list']['total']);
?>
 		<a href="admin_report.php?SECTION=<?php echo $this->_tpl_vars['sections'][$this->_sections['section_list']['index']]['ID']; ?>
&REPORT=FORM"><?php echo $this->_tpl_vars['sections'][$this->_sections['section_list']['index']]['NAME']; ?>
</a>&nbsp;|&nbsp;
 	<?php endfor; endif; ?>
	<br>
 	Payment: 
...
?>
 		<a href="admin_report.php?SECTION=<?php echo $this->_tpl_vars['sections'][$this->_sections['section_list']['index']]['ID']; ?>
&REPORT=PAYMENT"><?php echo $this->_tpl_vars['sections'][$this->_sections['section_list']['index']]['NAME']; ?>
</a>&nbsp;|&nbsp;
 	<?php endfor; endif; ?>
	<br>
 	Not Enrolled: 
...
?>
 		<a href="admin_report.php?SECTION=<?php echo $this->_tpl_vars['sections'][$this->_sections['section_list']['index']]['ID']; ?>
&REPORT=NOTENROLLED"><?php echo $this->_tpl_vars['sections'][$this->_sections['section_list']['index']]['NAME']; ?>
</a>&nbsp;|&nbsp;
 	<?php endfor; endif; ?>
    <br>
    Exceptions:
...
?>
        <a href="admin_report.php?SECTION=<?php echo $this->_tpl_vars['sections'][$this->_sections['section_list']['index']]['ID']; ?>
&REPORT=EXCEPTIONS"><?php echo $this->_tpl_vars['sections'][$this->_sections['section_list']['index']]['NAME']; ?>
</a>&nbsp;|&nbsp;
    <?php endfor; endif; ?>
