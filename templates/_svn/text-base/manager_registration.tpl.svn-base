  ...
  <tr>
	...
	<tr bgcolor="{cycle values="#eeeeee,#dddddd"}">
		...
		{if $user_access == "admin"}
	        	...
	        	<td style="padding: 0px 10px 0px 10px;">
	        	  <input type="checkbox" name="paperwork{$competitors[competitor_list].ID}" value="paperwork{$competitors[competitor_list].ID}" {if $competitors[competitor_list].PAPERWORK_RECEIVED} checked {/if}>
	        	</td>
	     {else if ($user_access == "manager" and $competitors[competitor_list].EDIT)}
	     		...
	     		<td style="padding: 0px 10px 0px 10px;">
	     			<input type="checkbox" name="Paperwork" value="Active" {if $competitors[competitor_list].paperwork_received} checked {/if} disabled>
	     		</td>
		{/if}
