<?php /* Smarty version 2.6.20, created on 2009-10-24 00:54:15
         compiled from manager_registration.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'manager_registration.tpl', 1, false),array('function', 'cycle', 'manager_registration.tpl', 50, false),array('modifier', 'date_format', 'manager_registration.tpl', 6, false),array('modifier', 'string_format', 'manager_registration.tpl', 99, false),)), $this); ?>
...
<h2>Competitors</h2>
<p class="legend">
Legend: S = Sparring, P = Patterns, ST = Special Techniques, PB = Power Breaking</br>
...
">
	        	...
	        	<td style="padding: 0px 10px 0px 10px;">
	        	  <input type="checkbox" name="paperwork<?php echo $this->_tpl_vars['competitors'][$this->_sections['competitor_list']['index']]['ID']; ?>
" value="paperwork<?php echo $this->_tpl_vars['competitors'][$this->_sections['competitor_list']['index']]['ID']; ?>
" <?php if ($this->_tpl_vars['competitors'][$this->_sections['competitor_list']['index']]['PAPERWORK_RECEIVED']): ?> checked <?php endif; ?>>
	        	</td>
	     <?php else: ?>
	    		 <td style="padding: 0px 10px 0px 10px;">
	     		...
	     		<td style="padding: 0px 10px 0px 10px;">
	     			<input type="checkbox" name="Paperwork" value="Active" <?php if ($this->_tpl_vars['competitors'][$this->_sections['competitor_list']['index']]['paperwork_received']): ?> checked <?php endif; ?> disabled>
	     		</td>
		<?php endif; ?>
